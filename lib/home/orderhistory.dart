...
class Orderhistory extends StatefulWidget {
  ...
  @override
  State<Orderhistory> createState() => _Order_detailState();
}

class _Order_detailState extends State<Orderhistory> {
  late int v_p_id;
  User? _user;
  ...
  void fetchVendorOrders() async {
    ...
    if (response.error == null) {
      ...
      var orderResponse = await http.get(
        Uri.parse('http://dev.codesisland.com/api/allriderorder/${v_p_id}'),
      );
              ...
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      ...
                      //         customerContact:
                      //             _orders[index]['customer_contact'].toString,
                      //       ),
                      //     ),
                      //   );
                      // },
                            ...
                            ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Total Price: ${_orders[index]['total_amount']}',
                                    style: const TextStyle(
                                      fontSize: 16.0,
                                    ),
                                  ),
                                  ...
                                  Text(
                                    'Address: ${_orders[index]['latitude']}',
                                    style: const TextStyle(
                                      fontSize: 16.0,
                                    ),
                                  ),
